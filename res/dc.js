...
dc.pieChart = function(parent, chartGroup) {
    ...
    _chart.changeListener = function(_) {
        if (!arguments.length) return _changeListener;
        _changeListener = _;
        return _chart;
    };
    ...
    function createSlicePath(slicesEnter, arc) {
        var slicePath = slicesEnter.append("path")
            ...
            .attr("d", arc);
	if (_brushOn)
		slicePath.on("click", onClick);
	else
		slicePath.attr("style","cursor:default");
    ...
    function createLabels(pieData, arc) {
	    ...
	    if (_brushOn)
                labelsEnter.on("click", onClick);
	    else
		labelsEnter.attr("style","cursor:default");
